...
Story: Logging in
  As an anonymous member with an account
  ...
  #
  Scenario: Anonymous member can log in
    Given an anonymous member
  ...
  Scenario: Logged-in member who logs in should be the new one
    Given an activated member named 'reggie'
     And  an activated member logged in as 'oona'
    When  she creates a singular sessions with login: 'reggie', password: 'monkey', remember me: ''
    Then  she should be redirected to the home page
    When  she follows that redirect!
    Then  she should see a notice message 'Logged in successfully'
  ...
  Scenario: Anonymous member can log in and be remembered
    ...
    Then  she should see a notice message 'Logged in successfully'
     ...
     And  her session store should have member_id: 4
  ...
  Scenario: Logged-in member who fails logs in should be logged out
    Given an activated member named 'oona'
    ...
    Then  she should see an error message 'Couldn't log you in as 'reggie''
     ...
     And  she should not have an auth_token cookie
     And  her session store should not have member_id
  ...
  Scenario: Logged in member can log out.
    Given an activated member logged in as 'reggie'
    When  she goes to /logout
    Then  she should be redirected to the home page
    When  she follows that redirect!
    Then  she should see a notice message 'You have been logged out'
